...
self.movies= [
    ...
    {id: "m06", movietitle: "Donnie Darko", release: "2001", director: "Richard Kelly", poster: "donnie-darko.jpg", synopsis: "After narrowly escaping a bizarre accident, a troubled teenager is plagued by visions of a large bunny rabbit that manipulates him to commit a series of crimes.", genre: "Drama", rate: "R"},
    
    {id: "m07", movietitle: "Frances Ha", release: "2012", director: "Noah Baumbach", poster: "frances-ha.jpg", synopsis: "An aspiring dancer moves to New York City and becomes caught up in a whirlwind of flighty fair-weather friends, diminishing fortunes and career setbacks.", genre: "Comedy", rate: "PG-13"},
    ...
    {id: "m10", movietitle: "Inside Out", release: "2015", director: "Pete Docter", poster: "inside-out.jpg", synopsis: "Growing up can be a bumpy road, and it’s no exception for Riley, who is uprooted from her Midwest life when her father starts a new job in San Francisco. Like all of us, Riley is guided by her emotions – Joy, Fear, Anger, Disgust and Sadness. The emotions live in Headquarters, the control center inside Riley’s mind, where they help advise her through everyday life. As Riley and her emotions struggle to adjust to a new life in San Francisco, turmoil ensues in Headquarters. Although Joy, Riley’s main and most important emotion, tries to keep things positive, the emotions conflict on how best to navigate a new city, house and school. ", genre: "Animation", rate: "G"},

    {id: "m11", movietitle: "Lady Bird", release: "2017", director: "Greta Gerwig", poster: "lady-bird.jpg", synopsis: "A California high school student plans to escape from her family and small town by going to college in New York.", genre: "Drama", rate: "R"},
    
    {id: "m12", movietitle: "Thor: Ragnarok", release: "2017", director: "Taika Waititi", poster: "ragnarok.jpg", synopsis: "Thor is on the other side of the universe and finds himself in a race against time to get back to Asgard to stop Ragnarok, the prophecy of destruction to his homeworld and the end of Asgardian civilization, at the hands of an all-powerful new threat, the ruthless Hela.", genre: "Action", rate: "PG-13"},
    
    {id: "m13", movietitle: "Scenes from the Suburbs", release: "2011", director: "Spike Jonze", poster: "sfts.jpg", synopsis: "A resident of a suburban dystopia tries to reassemble his fragmented memories of life as a teen.", genre: "Drama", rate: "PG-13"},

    {id: "m14", movietitle: "Suspiria", release: "2018", director: "Luca Guadagnino", poster: "suspiria.jpg", synopsis: "A young ballet dancer travels to a prestigious dance academy in Europe, only to discover it is a front for something far more sinister and supernatural amidst a series of increasingly grisly murders.", genre: "Horror", rate: "R"},
    ...
    {id: "m16", movietitle: "What We Do in the Shadows", release: "2014", director: "Taika Waititi", poster: "wwdits.jpg", synopsis: "Vampire housemates try to cope with the complexities of modern life and show a newly turned hipster some of the perks of being undead.", genre: "Comedy", rate: "PG-13"},
];
